...
func get()
{
  questionArr = ["How do I submit my work?","Who will own the Intellectual Property Rights of the product developed by my team?","How many elimination rounds will be there?","What is the weightage of each review?","Will I get food?","What do I do if I want to rest?","Who is on the Judging Panel?","Can we work on our own problem statements?","What do I do if I need an internet connection?","What will we be judging criterion?","Who do I contact if I face any problems?"]
  AnswerArr = ["You can submit your projects on our portal: c2c.acmvit.in/projects","The Intellectual Property Rights belong solely to your team until you collaborate with third parties.","There will be two elimination rounds - On 8th and 9th respectively. The top 6 teams will get a chance to present their hack in the final Expo.","We will take a note of your track and idea in review 1 while review 2 will be a technical inspection.","Yes you will get loads of yummy food to fill your bellies with!","You can relax in CS Hall and participate in one of the many fun activities to refresh your mind.","There will be one judging panel comprising of three judges.","Of course! As long as your problem statement is relevant to one of the tracks provided.","You will be provided with free access to our beloved internet facility, VOLSBB.","The criterion for evaluations are: Simplicity, Design, Solution to real time problem, Technology and Feasibility as a product.","You can call anyone from the organizing team. We will be happy to help!"]
